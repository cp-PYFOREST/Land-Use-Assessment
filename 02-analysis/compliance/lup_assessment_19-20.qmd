...
# Property Limit 
active_limit <- st_read(file.path(datadir, "lup_assessment_data/active_inactive/active_inactive1920.gpkg"))
...
write_rds(auth_year_group, "~/../../capstone/pyforest/lup_assessment_data/compliance_results/auth_year_group_050323.gpkg")
```
